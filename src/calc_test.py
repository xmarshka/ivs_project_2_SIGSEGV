...
#
# Popis: Testy matematickej knižnice calc.py
#
'''
##
# @file calc_test.py
...
class ToThePowerOfTest(unittest.TestCase):
    ...
    def test_failure_to_the_power_of(self):
        self.assertRaises(ValueError, to_the_power_of, -313, -2)
        self.assertRaises(ValueError, to_the_power_of, 191, 7.3)
        self.assertRaises(ValueError, to_the_power_of, 313, -3.17)
        self.assertRaises(ValueError, to_the_power_of, 17, -5)
        self.assertRaises(ValueError, to_the_power_of, 10.0, 500)
...
class RootTest(unittest.TestCase): # radicand and then index: square root of 4... root(4, 2) or root(4, )
    ...
    def test_failure_root_of(self):
        self.assertRaises(ValueError, root, -313, )
        self.assertRaises(ValueError, root, -313, 4)
        self.assertRaises(ValueError, root, 191, 7.3)
        self.assertRaises(ValueError, root, 313, -3.17)
        self.assertRaises(ValueError, root, 17, -5)
        self.assertRaises(ValueError, root, 19, 0)
...
class FactorialTest(unittest.TestCase):
    ...
    ##
    # @test Faktoriál desatinného čísla - ValueError
    # @test Faktoriál záporného čísla - ValueError
    def test_faulire_factorial(self):
        self.assertRaises(ValueError, factorial, 3.13)
        self.assertRaises(ValueError, factorial, -313)
...
class PrimeNumberTest(unittest.TestCase):
    ...
    ##
    # @test Testy, či sú čísla rôznej hodnoty správne určené ako prvočísla
    def test_prime(self):
    ...
    def test_failure_prime(self):
        ...
        self.assertRaises(ValueError, prime, 123.15)
